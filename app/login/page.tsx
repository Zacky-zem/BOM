        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          <div style={{
            ...
            <div style={{
              ...
              gap: 12,
              animation: 'fadeInLeft .6s ease .4s backwards',
            }}>
            </div>
            ...
            <div style={{
              ...
              alignItems: 'flex-start',
              gap: 12,
              animation: 'fadeInLeft .6s ease .5s backwards',
            }}>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Username */}
            <div style={{
              animation: 'slideUp .6s ease .3s backwards',
            }}>
              <label style={{
                display: 'block',
                fontSize: 12,
                fontWeight: 700,
                color: focused === 'username' ? '#1e40af' : '#64748b',
                marginBottom: 8,
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    background: '#fff',
                    transition: 'all .25s',
                    boxShadow: focused === 'username' ? '0 0 0 4px rgba(30,64,175,.1)' : 'none',
                  }}
                />
              </div>
            </div>
            ...
            {/* Password */}
            <div style={{
              animation: 'slideUp .6s ease .35s backwards',
            }}>
              <label style={{
                display: 'block',
                fontSize: 12,
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    background: '#fff',
                    transition: 'all .25s',
                    boxShadow: focused === 'password' ? '0 0 0 4px rgba(30,64,175,.1)' : 'none',
                  }}
                />
              </div>
            </div>
            ...
            <button
              ...
              onMouseOver={e => {
                if (!loading) {
                  ...
                  e.currentTarget.style.boxShadow = '0 12px 28px rgba(30,64,175,.35)';
                }
              }}
              onMouseOut={e => {
                if (!loading) {
                  e.currentTarget.style.transform = 'translateY(0)';
                  e.currentTarget.style.boxShadow = '0 8px 20px rgba(30,64,175,.25)';
                }
              }}
            >
              {loading ? (
